  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline:
          "text-indigo-500 border border-indigo-200 bg-white shadow-sm hover:bg-indigo-100 hover:text-indigo-500 dark:border-indigo-700 dark:bg-indigo-950 dark:hover:bg-indigo-700 dark:hover:text-indigo-50",
        secondary:
